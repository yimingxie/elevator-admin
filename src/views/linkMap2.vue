<template>
    <div class="main-wrap">
        ...
        <el-select @change="www()" v-model="value" placeholder="请选择"><el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option></el-select>
    </div>
  </template>
        ...
        methods: {
            initMap(){
                ...
                function markerClick(e) {
                    ...
                    //     offset: new AMap.Pixel(16, -45)
                    // });
                    component.$data.title = e.target.content
