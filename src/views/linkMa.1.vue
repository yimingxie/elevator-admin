  ...
  <script>
    ...
    export default {
        ...
        methods: {
            initMap(){
                // var add = '1111111111'
                // var sel = `<el-select v-model=${this.content} placeholder="请选择"><el-option v-for="(item, index) in options" :key="index" :label="item.label" :value="item.value"></el-option></el-select>`
                ...
                var MyComponent = Vue.extend({
                    ...
                    mounted(){
                        ...
                        console.log('222222==' + this.selectValue)
                        // if(this.title === 2){
                        //     alert(123)
                        //     this.options = [{
                        //         value: '12A',
                    ...
                    methods:{
                        www(){
                            // alert(234)
                            // document.getElementById('222').innerHTML = this.value
                        },
                        world:function() {
                            // alert(this.title)
                            // var obj = document.getElementById("dsd"); //定位id
                ...
                // function addMarker() {
                    ...
                    for (var i = 0, marker; i < lnglats.length; i++) {
                        ...
                        // content = [];
                        // content.push(this.content);
                        // component.$data.title = i
                        // console.log('2component.$el===' + component.$el)
